...
public class CamelliaCrypto extends CryptoBase {
    ...
    public static Map<String, String> getCiphers() {
        ...
        ciphers.put(CIPHER_CAMELLIA_128_CFB, CamelliaCrypto.class.getName());
        ciphers.put(CIPHER_CAMELLIA_192_CFB, CamelliaCrypto.class.getName());
        ciphers.put(CIPHER_CAMELLIA_256_CFB, CamelliaCrypto.class.getName());

        return ciphers;
    }

    public CamelliaCrypto(String name, String password) {
        super(name, password);
    }
